...
export function PasswordInput({ label,register,error,...rest }) { 
  ...
  return (
    ...
    <div className="relative input max-w-sm">
      <input
        ...
        {...rest}
        placeholder=""
        className={`block px-2.5 pb-2.5 pt-4 w-full text-gray-900 bg-transparent rounded-xl border-1 border-gray-300 appearance-none dark:border-gray-400 focus:border-transparent focus:outline-none focus:ring-2 ${error ? "focus:ring-red-600" : "focus:ring-blue-600"} peer`}
      />
      <label
